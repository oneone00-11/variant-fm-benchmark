...
The guard below keeps this importable: pytest collects every test_*.py / *_test.py
under the repository root, and the env-key check used to sys.exit at import time,
which aborted collection. Direct execution (python refs/ag_test.py) is unchanged.
"""
import os
import sys
