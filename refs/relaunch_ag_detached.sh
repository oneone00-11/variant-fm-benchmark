...
sleep 2
setsid bash -c 'source ~/miniforge3/etc/profile.d/conda.sh; conda activate alphagenome; python "/mnt/c/Users/张宁一/Desktop/variant-fm-benchmark/scripts/91_score_alphagenome.py" > /mnt/d/variant-fm-benchmark/refs/ag_detached.log 2>&1' < /dev/null &
disown 2>/dev/null
sleep 2
